...
def savings(gross_pay, tax_rate, expenses):
    ...
    tax_amount = int(int(gross_pay) * float(tax_rate))
    remaining_amount = gross_pay - tax_rate - expenses
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    total_consumed = int(num_jobs * job_consumption)
    remaining_material = int(total_material - total_consumed)
    output = f"{remaining_material}{material_units}"
    return output
print(material_waste)
